	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">Visualizar Projeto</h1>
						<ol class="breadcrumb">
							...
							<div class="col-lg-6">
								<div class="form-group">
									<label>Nome</label> <input type="text" value="${projeto.nome}"
										class="form-control" id="form-first-name" disabled>
								</div>
								<div class="form-group">
									<label>Cliente</label> <input type="text"
										value="${projeto.cliente.pessoa.nome}" class="form-control"
