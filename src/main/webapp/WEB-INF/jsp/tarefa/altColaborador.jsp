	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">Alterar Colaborador da Tarefa
							${tarefa.nome}</h1>
						<ol class="breadcrumb">
							...
							<div class="row">
								<div class="col-lg-12 form-group">
									<label>Colaboradores com compet&ecirc;ncia
										...
										class="form-control">
										<option value="${tarefa.colaboradorResponsavel.id}">${tarefa.colaboradorResponsavel.usuario}</option>
								...
								<div class="form-group col-lg-4 col-lg-offset-4">
									<button type="submit" class="col-lg-12 btn btn-success">Alterar</button>
								</div>
							</div>
						</form>
					</div>
